    ...
    json_data = {
        "payload": {
            ...
            "with": {
                "attributes": {
                    "withKey": [
                        "learnMoreType", "sizeGuideActivated", "sizeGuideType", "sizeGuideBrand", "harrodsColour",
                        "brand", "sAPBrand", "name", "promotion", "fastenerType", "design", "extras", "material",
                        "print", "careInstructions", "fitting", "upperLength", "sleeveLength", "shirtCut",
                        "shortsLength", "trousersLength", "skirtLength", "neckline", "trousersCut", "vendorColour",
                        "promotionTag", "exclusive", "contentTags", "reductionType", "nonReturnable", "gender",
                        "grapeVariety", "wineRegion", "luggageCaseType", "pattern", "numberOfSeats", "necklineType",
                        "collarType", "sleeveType", "denimWash", "rise", "claspDetail", "strapDetail", "hardwareDetail",
                        "eyewearLensTint", "uvProtection", "burnTime", "fitType", "heelType", "towelType", "towelSize",
                        "beddingType", "beddingSize", "fillingType", "duvetTog", "dishwasherSafe", "microwaveSafe",
                        "compatibleWith", "suitableFrom", "modelSize", "leadTime", "fasteningType", "alcoholContent",
                        "dietaryInformation", "wineVintageYear", "bottleClosure", "numberOfRecliningPositions",
                        "coverage", "finishType", "skinConcern", "skinType", "sPF", "hairConcernType", "hairType",
                        "fragranceType", "containsAlcohol", "watchDialShape", "watchCaseComposition",
                        "watchMovementType", "strapMovementFeatures", "hallmarking", "subBrand", "priceOnApplication",
                        "inStoreOnly", "sellableWithoutStock", "preOrder", "category", "soldOut", "groupingType",
                        "volumeDescription", "threadCount", "rolexNonTransactional", "rolexReference", "rolexAge",
                        "rolexMaterial", "rolexDiameter", "rolexStockNumber", "rolexModel", "rolexOriginalBox",
                        "rolexOriginalPapers", "rolexBezel", "rolexDial", "rolexCrystal", "rolexMovement",
                        "rolexCalibre", "rolexPowerReserve", "rolexBracelet", "rolexWaterproof", "rolexCollection"
                    ]
                },
                "advancedAttributes": {
                    "withKey": [
                        "promotionMessage", "materialCompositionTextile", "productDescription", "combineWith",
                        "additionalService", "quote", "materialComposition", "buggyContents", "beautyProductBenefit",
                        "ingredients", "nutritionalInformation", "fabric", "exteriorPockets", "interiorPockets",
                        "fragranceNotes", "functionalFeatures", "productDimensions", "productWeight", "capacity",
                        "productContents", "power", "madeInCountry", "specialPackagingDetail", "warranty", "disclaimer",
                        "productModelNumber", "storageConditions", "fragranceTopNotes", "fragranceMiddleNotes",
                        "fragranceBaseNotes", "dietaryInformation", "mayContain", "watchCaseMeasurement",
                        "gemstoneSetting", "watchCaseWaterResistance", "watchDialClarity", "availableAt",
                        "hamperContentInformation", "alcoholContent", "containsAlcohol", "vendorReference"
                    ]
                },
                "variants": {
                    "attributes": {
                        "withKey": ["price", "size", "subscriptionEligibility", "maximumQuantityPerOrder",
                                    "volumeDescription"]
                    },
                ...
                "images": {
                    "attributes": {
                        "withKey": ["imageType", "imageView", "imageBackground", "digitalAssetType", "imagePosition"]
                    }
                },
                "categories": "all",
                "priceRange": True,
